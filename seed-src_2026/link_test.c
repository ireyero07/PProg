...
int main(int argc, char** argv) {
  ...
  if (all || test == 3) test1_inventory_get_max_objs();
  if (all || test == 4) test2_inventory_get_max_objs();
  ...
  if (all || test == 10) test1_inventory_del_object();
  if (all || test == 11) test2_inventory_del_object();
  if (all || test == 12) test3_inventory_del_object();
  if (all || test == 13) test1_inventory_has_object();
  if (all || test == 14) test2_inventory_has_object();
  if (all || test == 15) test3_inventory_has_object();
  if (all || test == 16) test1_inventory_get_objects();
  if (all || test == 17) test2_inventory_get_objects();
  if (all || test == 18) test1_inventory_get_number_objects();
  if (all || test == 19) test2_inventory_get_number_objects();
